...
contract SotoCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function SotoCoin() {
        ...
        name = "SotoCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "SOTO";                                             // Set the symbol for display purposes (CHANGE THIS)
